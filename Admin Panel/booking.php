...
<body>
    ...
    <body id="body-pd">
       ...
       <div class="catheader"><h4 class="h3 mb-4 text-gray-800">Booking Management</h4></div>
                ...
                <div class="card-header py-3">
                    <div class="row">
                        ...
                        <div class="col" align="right">
                            <button type="button" name="add_category" id="add_category" class="btn btn-succss btn-circle btn-sm"> </a>
                                <a href="booking-add.php"><i class="fas fa-plus"></i></a>
                        ...
                        if(mysqli_num_rows($query_run) > 0)
                        {
                            foreach($query_run as $row)
                            {
                                ...
                                <tr>
                                    ...
                                    <td><?=$row['Email']; ?></td>
                                    <td><a href="booking-edit.php?booking-no=<?=$row['Booking_No'];?>" class="btn btn-success">Edit</a></td>
                                    <td>
                                        <form action="code.php" method="POST">
                                        <button type="submit" name="delete_booking" value="<?=$row['Booking_No'];?>" class="btn btn-success">Delete</a>
                                        </form>
                                    </td>
                                </tr>
                                <?php
