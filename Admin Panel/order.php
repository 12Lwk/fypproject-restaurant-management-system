...
<body>
    ...
    <body id="body-pd">
       ...
       <div class="catheader"><h4 class="h3 mb-4 text-gray-800">Order Management</h4></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col" align="right">
                            <button type="button" name="add_category" id="add_category" class="btn btn-succss btn-circle btn-sm">
                                <a href="order-add.php"><i class="fas fa-plus"></i></a>
                        ...
                        if(mysqli_num_rows($query_run) > 0)
                        {
                            foreach($query_run as $row)
                            {
                                ...
                                <tr>
                                    ...
                                    <td><a href="order-edit.php?order-id=<?=$row['Order_ID'];?>" class="btn btn-success">Edit</a></td>
                                    <td>
                                        <form action="code.php" method="POST">
                                        <button type="submit" name="delete_order" value="<?=$row['Order_ID'];?>" class="btn btn-success">Delete</a>
                                        </form>
                                    </td>
                                    <th><a href="order-view.php?order-id=<?=$row['Order_ID'];?>" class="btn btn-success">View</a></th>
                                </tr>
                                <?php
                            }
