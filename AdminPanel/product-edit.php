...
<body>
    ...
    <body id="body-pd">
       ...
       <div class="catheader"><h4 class="h3 mb-4 text-gray-800">Product</h4></div>
        <div class="height-200 bg-light">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="container-fluid">
                    ...
                    {
                        $product_no = $_GET['product-id'];
                        $product = "SELECT * FROM product WHERE Product_ID='$product_no'";
