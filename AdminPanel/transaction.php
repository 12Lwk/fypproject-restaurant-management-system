    ...
    <body id="body-pd">
        ...
        <nav class="nav">
                <div><a href="dashboard.php" class="nav_logo"> <i class='bx bx-layer nav_logo-icon'></i> <span class="nav_logo-name">Admin Panel</span> </a>
                    ...
                    <a href="transaction.php" class="nav_link active"> <i class='bx bx-credit-card'></i><span class="nav_name">Transaction</span> </a>
                </div>
       ...
       <div class="catheader"><h4 class="h3 mb-4 text-gray-800">Transaction</h4></div>
        ...
        <div class="height-200 bg-light">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <div class="row">
                        <div class="col">
                            <h6 class="m-0 font-weight-bold text-primary">Transcation List</h6>
                        </div>
